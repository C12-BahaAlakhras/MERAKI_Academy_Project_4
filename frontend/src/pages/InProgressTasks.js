  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const inProgressTicket = allTasksArray.filter((ticket) => {
          return ticket.ticketStatus === "In-Progress";
        });

        // console.log("completedTicket", completedTicket);
        setAllTasksInProgress(inProgressTicket);
        //================================
      })
      .catch((err) => {
  ...
  return (
    <>
      <div className="tasks-container">
        <h1 className="font-black">In-Progress Task List</h1>
